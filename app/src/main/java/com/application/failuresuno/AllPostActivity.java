...
public class AllPostActivity extends AppCompatActivity implements FilterListener<Tag> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilter.setListener(AllPostActivity.this);
      ...
      recyclerView = findViewById(R.id.list);
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(AllPostActivity.this,LinearLayoutManager.VERTICAL,false);
...
filter=item.getText();
    ...
    class Adapter extends FilterAdapter<Tag> {
        ...
        public FilterItem createView(int position, Tag item) {
            FilterItem filterItem = new FilterItem(AllPostActivity.this);

            // filterItem.setStrokeColor(mColors[0]);
            filterItem.setTextColor(ContextCompat.getColor(AllPostActivity.this, android.R.color.white));
            filterItem.setStrokeColor(ContextCompat.getColor(AllPostActivity.this, android.R.color.black));
            //  filterItem.setTextColor(mColors[0]);
            filterItem.setCornerRadius(14);
            filterItem.setCheckedTextColor(ContextCompat.getColor(AllPostActivity.this, android.R.color.white));
    ...
    public void getData(){
        final ProgressDialog progressDialog=new ProgressDialog(AllPostActivity.this);
...
progressDialog.dismiss();
                ...
                {
                    Toast.makeText(AllPostActivity.this, "No Post Found..!", Toast.LENGTH_SHORT).show();
                }
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(AllPostActivity.this);
